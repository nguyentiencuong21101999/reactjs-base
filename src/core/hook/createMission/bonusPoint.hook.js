...
const BonusPointHook = props => {
    ...
    const onChange = event => {
        try {
            ...
            const temp = value
            setPassword(temp)
            Validator.isNotEmpty(name, temp, Localize.getLocalize("LC_NUMBER_EMPTY"))
            Validator.isValidPointChallengeMission(name, temp, Localize.getLocalize("LC_VALUE_INVALID"))
