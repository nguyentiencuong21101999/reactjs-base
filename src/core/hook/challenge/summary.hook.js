 ...
 */
 ...
 const SummaryHook = props => {
 
     const { style, styleFormControl,required, services, id, label, name, placeholder, value, disabled, index } = props
     ...
     const onChange = event => {
         try {
            ...
            //  Validator.isContentSms(name, temp,Localize.getLocalize("LC_CONTENT_INVALID"));
