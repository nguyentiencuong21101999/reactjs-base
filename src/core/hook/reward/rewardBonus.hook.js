...
const TitleHook = props => {
  ...
  const onChange = event => {
    try {
      ...
      const temp = value
      setPassword(temp)
      Validator.isNotEmpty(name, temp, Localize.getLocalize("LC_POINT_REQUIRED_EMPTY"))
      Validator.isQuantityBonusReward(name, temp, Localize.getLocalize("LC_POINT_REQUIRED_INVALID"))
