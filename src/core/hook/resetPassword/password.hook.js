...
const PasswordHook = props => {
  ...
  const { name, placeholder, value, type, label, disabled, required, isRow, styleLabel } = props;
  ...
  const onChange = event => { 
    ...
    try {
      ...
      setPassword(temp)
      Validator.isNotEmpty(name, temp, Localize.getLocalize('LC_PASSWORD_EMPTY'))
      Validator.isPasswordReset(name,temp,Localize.getLocalize("LC_PASSWORD_INVALID"))
