 ...
 */
 ...
 const ContentHook = props => {
   ...
   const { name, placeholder, value, type, label, disabled, styleFormControl, isRow, minRows, maxRows } = props;
   ...
   const onChange = data => {
     try {
       ...
       //Validator.isNotEmpty(name, temp, Localize.getLocalize('LC_CONTENT_INVALID'))
