...
const TitleHook = props => {
  ...
  const onChange = event => {
    try {
      ...
      const temp = value
      setPassword(temp)
      Validator.isNotEmpty(name, temp, Localize.getLocalize("LC_CATEGORY_NAME_EMPTY"))
     // Validator.isNotEmpty(name, temp, Localize.getLocalize("LC_CATEGORY_NAME_INVALID"))
