...
const ListCategoryHtml = (props) => {
  ...
  const headerRows = [
    { value: Localize.getLocalize("LC_CATALOG"), align: "left" },
    { value: Localize.getLocalize("LC_NAME"), align: "left" },
  ...
  const cells = [
    { field: "menuCategoryParentName", align: "left", parser: (value) => { return value } },
    { field: "menuCategoryName", align: "left" },
...
export default ListCategoryHtml;
