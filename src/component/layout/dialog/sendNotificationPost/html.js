...
const Html = (props) => {
  const { handleClose, handleSubmit, timeout, ui, handleOnChange, handleOnRef, handleOnChangeTarget } = props;
    ...
    <Styles.fill isOpen={open}>
      <Styles.container isOpen={open} width={488}>
        ...
        <Styles.body style={{ paddingBottom: 0 }}>
          <Stack direction="column" spacing={1} sx={{ p: 0.5 }}>
            ...
            <Stack direction="column" spacing={1} sx={{ p: 0.5 }}>
              <ContentSendNotifyHook
                ...
                styleFormControl={{ fontSize: "16px", width: "95%", marginBottom: "10px" }}
                onRef={handleOnRef}
                onChange={handleOnChange}
                fullWidth={false}
                required={true}
          ...
          <Styles.wrapper data-test-id="popupContent">
            <MultiSelect
              ...
              styleFormControl={{ maxWidth: "700px", marginLeft: "10px" }}
              styleLabel={{ marginLeft: "15px" }}
              disabled={timeout.status}
              notOutline={false}
              fullWidth={false}
              isRow={false}
          ...
          <Stack alignItems="center" sx={{ marginLeft: "15px", marginTop: "10px", color: "rgb(107, 119, 140)" }}>
        ...
        <Styles.footer>
          ...
          <Button testId="popupConfirm" text={Localize.getLocalize("LC_BUTTON_CONFIRM")} onClick={(e) => { e.preventDefault(); handleSubmit() }} disabled={ui.isShowBtn || timeout.status} />
