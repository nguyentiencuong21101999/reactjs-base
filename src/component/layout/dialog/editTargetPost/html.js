    ...
    return (
        <Styles.fill isOpen={open}>
            <Styles.container isOpen={open} width={488}>
                <Styles.head>
                    <Styles.title data-test-id="popupTitle">{Localize.getLocalize("LC_POPUP_UPDATE_OBJECT_POST_TITLE")}</Styles.title>
                ...
                <Styles.body style={{ paddingBottom: 0 }}>
                    <Styles.wrapper data-test-id="popupContent">
                        <Styles.headerTitle>
                            <Stack sx={{ marginBottom: "10px", color: "#333333", width: "445px" }}>{Localize.getLocalize("LC_POPUP_UPDATE_OBJECT_POST_CONTENT")}</Stack>
                            <MultiSelect
                                label={Localize.getLocalize("LC_OBJECT")}
                                list={ui.listTarget}
                                defaultValue={ui.defaultTarget}
                                onChange={handleOnChange}
                                styleFormControl={{ maxWidth: '800px' }}
                                // styleMenu={}
