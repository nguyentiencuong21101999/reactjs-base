...
const ApproveSubChallengeHtml = props => {
    ...
    <Styles.fill isOpen={open}>
      <Styles.container isOpen={open} width={488}>
        <Styles.head variant='success'>
          <Styles.title data-test-id="popupTitle">{Localize.getLocalize("LC_APPLY")}</Styles.title>
        ...
        <Styles.body>
          <Styles.wrapper>
            ...
            <Styles.content data-test-id="popupContent">
              <Stack> {Localize.getLocalize("LC_APPLY_SUB_CHAL_CONTENT")}</Stack>
              <Stack> {Localize.getLocalize("LC_APPLY_SUB_CHAL_NOTE")}</Stack>
            </Styles.content>
          </Styles.wrapper>
        </Styles.body>
        <Styles.footer>
...
export default ApproveSubChallengeHtml
