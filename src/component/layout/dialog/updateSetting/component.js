...
class EditTargetPostComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      func: {
        ...
        handleUpdateSettingFailed: this.handleUpdateSettingFailed.bind(this),
        handleUpdateSettingSuccess: this.handleUpdateSettingSuccess.bind(this),
      },
      ui: {
        isShowBtn: true,
        listTarget: [
  ...
  handleUpdateSettingSuccess(response) {
  ...
  handleUpdateSettingFailed() {
    Logger.info(`EditTargetPostComponent execute handleUpdateSettingFailed`);
    const { timeout, data, ui } = this.state;
  ...
  UNSAFE_componentWillMount() {
    try {
      ...
      const { configId } = allReducer.dialog.data.content;
  ...
  handleRequest() {
    try {
      ...
      updateSetting(timeout.key, data);
    } catch (e) {
