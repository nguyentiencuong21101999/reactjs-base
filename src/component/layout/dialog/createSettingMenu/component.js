...
class EditTargetPostComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      data: new ModelView(),
      func: {
        handleCreateMenuSettingFailed: this.handleCreateMenuSettingFailed.bind(this),
        handleCreateMenuSettingSuccess: this.handleCreateMenuSettingSuccess.bind(this),
  ...
  handleCreateMenuSettingSuccess(response) {
  ...
  handleCreateMenuSettingFailed() {
    Logger.info(`EditTargetPostComponent execute handleCreateMenuSettingFailed`);
  ...
  handleRequest() {
    try {
      ...
      const { createMenuSetting } = this.props;
      createMenuSetting(timeout.key, data);
    } catch (e) {
